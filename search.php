...
?>
<?php 
$resultsearch= $_SESSION['$resultsearcho'];
...
while ($row = mysqli_fetch_assoc($lastgenres)) {
 ...
 <main class="container">
    <div class="p-4 p-md-5 mb-4 rounded text-bg-dark">
      ...
      <div class="row g-5">
        <div class="col-md-8">
        <h3 class="pb-2 mb-6 fst-italic border-bottom" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;"><span id="countid">0</span> RESULTS FOR "<?php echo $resultsearch ?>"              </h3>
          ...
          <article class="blog-post">
            ...
            <div class="row" style="color:dark; min-height:200px; margin-right: 3px;">
              ...
              <?php
              $count=0;
              $cards_data = mysqli_query($conn, "SELECT * FROM manhwa where Man_name Like '%$resultsearch%';");
